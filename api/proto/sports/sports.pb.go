...
type Sport_Status int32

const (
	Sport_CLOSED Sport_Status = 0
	Sport_OPEN   Sport_Status = 1
)

// Enum value maps for Sport_Status.
var (
	Sport_Status_name = map[int32]string{
		0: "CLOSED",
		1: "OPEN",
	}
	Sport_Status_value = map[string]int32{
		"CLOSED": 0,
		"OPEN":   1,
	}
)

func (x Sport_Status) Enum() *Sport_Status {
	p := new(Sport_Status)
	*p = x
	return p
}

func (x Sport_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Sport_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_sports_sports_proto_enumTypes[1].Descriptor()
}

func (Sport_Status) Type() protoreflect.EnumType {
	return &file_sports_sports_proto_enumTypes[1]
}

func (x Sport_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Sport_Status.Descriptor instead.
func (Sport_Status) EnumDescriptor() ([]byte, []int) {
	return file_sports_sports_proto_rawDescGZIP(), []int{6, 0}
}

type FetchSportRequest struct {
...
func (x *FetchSportRequest) Reset() {
	*x = FetchSportRequest{}
...
func (x *FetchSportRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchSportRequest) ProtoMessage() {}

func (x *FetchSportRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sports_sports_proto_msgTypes[0]
...
// Deprecated: Use FetchSportRequest.ProtoReflect.Descriptor instead.
func (*FetchSportRequest) Descriptor() ([]byte, []int) {
	return file_sports_sports_proto_rawDescGZIP(), []int{0}
}

func (x *FetchSportRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type FetchSportResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FetchSportResponse) Reset() {
	*x = FetchSportResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *FetchSportResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchSportResponse) ProtoMessage() {}

func (x *FetchSportResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sports_sports_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchSportResponse.ProtoReflect.Descriptor instead.
func (*FetchSportResponse) Descriptor() ([]byte, []int) {
	return file_sports_sports_proto_rawDescGZIP(), []int{2}
}

func (x *FetchSportResponse) GetSport() *Sport {
	if x != nil {
		return x.Sport
	}
	return nil
...
func (x *ListSportsRequestFilter) GetOrderBy() *OrderBy {
	if x != nil {
		return x.OrderBy
	}
	return nil
...
type OrderBy struct {
	...
	Direction OrderBy_Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=sports.OrderBy_Direction" json:"direction,omitempty"`
}
...
type Sport struct {
	...
	Status Sport_Status `protobuf:"varint,7,opt,name=status,proto3,enum=sports.Sport_Status" json:"status,omitempty"`
}
...
func (x *Sport) GetStatus() Sport_Status {
	if x != nil {
		return x.Status
	}
	return Sport_CLOSED
...
var file_sports_sports_proto_rawDesc = []byte{
	...
	0x46, 0x65, 0x74, 0x63, 0x68, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x22, 0x4c, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x2e,
	...
	0x39, 0x0a, 0x12, 0x46, 0x65, 0x74, 0x63, 0x68, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a, 0x05, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x2e, 0x53, 0x70,
	0x6f, 0x72, 0x74, 0x52, 0x05, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x3b, 0x0a, 0x12, 0x4c, 0x69,
	...
	0x06, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x89, 0x01, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74,
	...
	,
	...
	0x9a, 0x02, 0x0a, 0x05, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x74, 0x69, 0x73, 0x65, 0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x2c,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14,
	0x2e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x2e, 0x53, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x53, 0x74,
	...
	,
...
var file_sports_sports_proto_goTypes = []interface{}{
	(OrderBy_Direction)(0),          // 0: sports.OrderBy.Direction
	(Sport_Status)(0),               // 1: sports.Sport.Status
	(*FetchSportRequest)(nil),       // 2: sports.FetchSportRequest
	(*ListSportsRequest)(nil),       // 3: sports.ListSportsRequest
	(*FetchSportResponse)(nil),      // 4: sports.FetchSportResponse
	(*ListSportsResponse)(nil),      // 5: sports.ListSportsResponse
	(*ListSportsRequestFilter)(nil), // 6: sports.ListSportsRequestFilter
	(*OrderBy)(nil),                 // 7: sports.OrderBy
	(*Sport)(nil),                   // 8: sports.Sport
	(*timestamppb.Timestamp)(nil),   // 9: google.protobuf.Timestamp
}
var file_sports_sports_proto_depIdxs = []int32{
	6, // 0: sports.ListSportsRequest.filter:type_name -> sports.ListSportsRequestFilter
	8, // 1: sports.FetchSportResponse.sport:type_name -> sports.Sport
	8, // 2: sports.ListSportsResponse.sports:type_name -> sports.Sport
	7, // 3: sports.ListSportsRequestFilter.order_by:type_name -> sports.OrderBy
	0, // 4: sports.OrderBy.direction:type_name -> sports.OrderBy.Direction
	9, // 5: sports.Sport.advertised_start_time:type_name -> google.protobuf.Timestamp
	1, // 6: sports.Sport.status:type_name -> sports.Sport.Status
	3, // 7: sports.Sporting.ListSports:input_type -> sports.ListSportsRequest
	2, // 8: sports.Sporting.FetchSport:input_type -> sports.FetchSportRequest
	5, // 9: sports.Sporting.ListSports:output_type -> sports.ListSportsResponse
	4, // 10: sports.Sporting.FetchSport:output_type -> sports.FetchSportResponse
...
func file_sports_sports_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sports_sports_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchSportRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sports_sports_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchSportResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
